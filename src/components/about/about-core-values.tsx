...
const VALUES: Value[] = [
  {
    ...
    desc: "Từ nguồn cung uy tín trong nước và nhập khẩu, kiểm soát chặt chẽ từng lô.",
    icon: (
  ...
  },
  {
    ...
    desc: "Quy trình khép kín, đạt chuẩn HACCP và ISO 22000:2018 quốc tế.",
    icon: (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" className={I} aria-hidden>
  ...
  {
    title: "Tiện lợi & ngon miệng",
    desc: "Sản phẩm đa dạng, chế biến đơn giản nhưng giữ trọn hương vị truyền thống.",
    icon: (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" className={I} aria-hidden>
  ...
  },
  {
    ...
    desc: "Vì sức khỏe người Việt và phát triển bền vững cùng cộng đồng.",
    icon: (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" className={I} aria-hidden>
      ...
      <div className="container-page">
        <Reveal>
          ...
          <p className="mx-auto mt-2 max-w-xl text-center text-sm text-[var(--color-ink-muted)] md:text-base">
            Những giá trị làm nên tinh thần Tâm Lợi Foods
          </p>
        </Reveal>
        ...
        <div className="mt-10 grid items-center gap-10 md:grid-cols-2 md:gap-14">
          ...
          <div className="grid gap-5 sm:grid-cols-2">
            {VALUES.map((v, i) => (
              <Reveal key={v.title} direction="up" delay={i * 100}>
